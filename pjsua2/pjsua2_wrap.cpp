...
SWIGEXPORT void SWIGSTDCALL CSharp_pj_qos_params_flags_set(void * jarg1, unsigned char jarg2) {
  struct pj_qos_params *arg1 = (struct pj_qos_params *) 0 ;
  pj_uint8_t arg2 ;
  
  arg1 = (struct pj_qos_params *)jarg1; 
...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_pj_qos_params() {
  void * jresult ;
  struct pj_qos_params *result = 0 ;
  
  result = (struct pj_qos_params *)calloc(1, sizeof(struct pj_qos_params));
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void SWIGSTDCALL CSharp_pj_set(void * jarg1) {
  namespace arg1 ;
  namespace *argp1 ;
...
SWIGEXPORT void * SWIGSTDCALL CSharp_pj_get() {
  void * jresult ;
  namespace result;

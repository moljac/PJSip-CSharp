...
SWIGEXPORT void SWIGSTDCALL CSharp_Endpoint_libRegisterWorkerThread(void * jarg1, char * jarg2) {
  ...
  arg2 = &arg2_str; 
  try {
    (arg1)->libRegisterWorkerThread((pj::string const &)*arg2);
  }
  catch(pj::Error &_e) {
    (void)_e;
    SWIG_CSharpSetPendingException(SWIG_CSharpApplicationException, "C++ pj::Error exception thrown");
...
SWIGEXPORT void SWIGSTDCALL CSharp_AccountRegConfig_unregWaitSec_set(void * jarg1, unsigned int jarg2) {
  pj::AccountRegConfig *arg1 = (pj::AccountRegConfig *) 0 ;
  unsigned int arg2 ;
...
SWIGEXPORT unsigned int SWIGSTDCALL CSharp_AccountRegConfig_unregWaitSec_get(void * jarg1) {
  unsigned int jresult ;
  pj::AccountRegConfig *arg1 = (pj::AccountRegConfig *) 0 ;
  unsigned int result;
